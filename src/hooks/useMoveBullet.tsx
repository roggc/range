...
export const useMoveBullet = ({
    ...
    refUnits,
    refOtherUnits,
}: IUseMoveBulletProps): [boolean, (e: React.MouseEvent) => void] => {
    ...
    const numberOfPixelsPerUnit =
        min && max
            ? (refBar.current?.getBoundingClientRect().right! -
